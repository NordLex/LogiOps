...
/**Init data methods*/
static void
init_dpi(LDevice *device, GtkWidget *parent) {
    Dpi *dpi = l_device_get_dpi(device);
...
static void
init_hiresscroll(LDevice *device, GtkWidget *parent) {
...
static void
clear_content(GtkWidget *container) {
